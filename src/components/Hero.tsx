...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col justify-center items-center px-6 md:px-12">
      ...
      <div className="max-w-6xl w-full mx-auto pt-24 md:pt-32 flex flex-col items-center">
        <div className="text-center mb-8">
          <div 
            className={cn(
              "inline-block bg-primary/10 text-primary px-4 py-1.5 rounded-full mb-6 transition-all duration-700",
          ...
          <h1 
            className={cn(
              "text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight transition-all duration-700 delay-100",
              isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            )}
          >
        ...
        <div 
          className={cn(
            "flex flex-col sm:flex-row gap-4 mt-8 transition-all duration-700 delay-300",
            isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          )}
        >
          <Link to="/demo">
